...
const itRegionElement = (id: string, element: React.ReactElement) => {
  it(id, async () => expectRegionElement(await getDataElement(render(<Provider>{element}</Provider>).getByTestId(id))));
};

const itRegionsElement = (id: string, element: React.ReactElement) => {
  it(id, async () => expectRegionsElement(await getDataElement(render(<Provider>{element}</Provider>).getByTestId(id))));
};
